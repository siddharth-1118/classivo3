export type ConnectionSource = "academia" | "srm_portal";
...
export interface AcademiaData {
  ...
  timetableSource?: "srm_student_portal" | "academia";
  timetableNote?: string;
  timetableNeedsAcademia?: boolean;
  needsAcademia?: boolean;
  source?: "academia" | "srm_portal";
...
export interface ConnectionStatus {
  portal_type: "student_portal" | "academia";
  status: "active" | "inactive" | "expired" | "error";
  connected_at: string;
  last_successful_sync: string | null;
}

export interface AcademicRouting {
  academicYear: number;
  isFirstYear: boolean;
  needsAcademia: boolean;
  studentPortalProvides: string[];
  academiaProvides: string[];

...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen text-[#dfe1f4] flex flex-col font-sans relative bg-[#05060a]">
      ...
      <div className="fixed top-[-15%] right-[-10%] w-[60vw] h-[45vh] bg-cyan-500/10 rounded-full blur-[140px] pointer-events-none animate-aurora" />
      <div className="fixed bottom-[-10%] left-[-10%] w-[50vw] h-[40vh] bg-violet-500/10 rounded-full blur-[140px] pointer-events-none animate-aurora" style={{ animationDelay: "-4s" }} />
      <div className="fixed top-[30%] left-[40%] w-[30vw] h-[30vh] bg-amber-300/5 rounded-full blur-[120px] pointer-events-none animate-aurora" style={{ animationDelay: "-7s" }} />

      {/* Header */}
      <header className="sticky top-0 z-50 flex justify-between items-center py-4 px-6 max-w-4xl mx-auto w-full backdrop-blur-2xl bg-[#05060a]/75 border-b border-white/10 shadow-2xl">
        <div className="flex items-center gap-2.5">
          <div className="w-8.5 h-8.5 rounded-xl flex items-center justify-center gradient-brand shadow-[0_4px_20px_rgba(34,211,238,0.4)]">
            <span className="material-symbols-outlined text-[17px] text-[#05060a] font-black">diamond</span>
          </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-5 py-2 rounded-full text-xs font-black uppercase tracking-wider btn-ghost border border-white/10 hover:border-cyan-400/40 transition-all active:scale-95"
          >
            sign in
          </button>
        </div>
      ...
      <main className="flex-1 w-full">
        <section className="flex flex-col items-center justify-center text-center max-w-3xl mx-auto w-full py-16 px-6 relative z-10">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-cyan-500/10 border border-cyan-500/30 rounded-full text-cyan-300 text-[10.5px] font-bold uppercase tracking-wider mb-6 backdrop-blur-md shadow-[0_0_15px_rgba(6,182,212,0.15)]">
            <Shield size={12} className="text-cyan-400" /> SRM Institute • Privacy-First Portal
          </div>
          ...
          {/* Subline */}
          <p className="text-[14px] sm:text-base text-white/60 max-w-xl leading-relaxed mb-10 font-medium">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-3.5 mb-20 w-full justify-center">
            <button
              onClick={() => router.push("/login")}
              className="group px-8 py-4 rounded-2xl text-[14px] font-black uppercase tracking-widest btn-aurora flex items-center justify-center gap-2 shadow-[0_0_24px_rgba(34,211,238,0.3)] hover:scale-[1.02] active:scale-[0.98] transition-all"
            >
              get started free
            ...
            <a
              ...
              className="group px-8 py-4 rounded-2xl text-[14px] font-black uppercase tracking-widest btn-ghost border border-white/10 hover:border-violet-400/40 flex items-center justify-center gap-2 backdrop-blur-md active:scale-[0.98] transition-all"
            >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 w-full mb-16">
            {stats.map(({ value, label, icon }) => (
              <div key={label} className="aurora-surface rounded-2xl p-4 text-center border border-white/10 backdrop-blur-xl hover:border-cyan-400/30 transition-all">
                <div className="flex items-center justify-center mb-2">{icon}</div>
                <div className="text-[22px] font-black text-white">{value}</div>
                <div className="text-[9.5px] text-white/50 font-bold uppercase tracking-wider mt-1">{label}</div>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="max-w-4xl mx-auto px-6 pb-16">
          <div className="flex items-center gap-2 px-2 mb-6">
            ...
            <div className="flex-1 h-[1.5px] bg-[#6EE7F7]/20 rounded-full" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {features.map(({ icon, title, desc, color }) => (
              <div 
                key={title}
                className="aurora-surface aurora-surface-hover rounded-2xl p-5 text-left relative overflow-hidden border border-white/10 backdrop-blur-xl hover:border-cyan-400/30 transition-all"
              >
                <div className="flex items-center gap-3 mb-2.5">
                  <div className="p-2 bg-white/5 rounded-xl border border-white/10">
                    {icon}
                  </div>
                  <h3 className="text-[13.5px] font-extrabold text-white lowercase tracking-tight">
                    {title.toLowerCase()}
                  </h3>
                </div>
        ...
        <section className="max-w-4xl mx-auto px-6 pb-20">
          <div 
            className="rounded-3xl p-8 relative overflow-hidden text-center aurora-surface border border-white/15 backdrop-blur-2xl shadow-2xl"
            style={{ background: "linear-gradient(135deg, rgba(34,211,238,0.12) 0%, rgba(129,140,248,0.12) 100%)", border: "1px solid rgba(110,231,247,0.2)" }}
          >
            <div className="absolute -top-16 -right-16 w-48 h-48 bg-cyan-400/10 rounded-full blur-3xl pointer-events-none animate-aurora" />
            <div className="absolute -bottom-12 -left-12 w-40 h-40 bg-violet-400/10 rounded-full blur-3xl pointer-events-none animate-aurora" style={{ animationDelay: "-4s" }} />
            <div className="flex items-center justify-center mb-4 relative z-10">
              <div className="p-3 bg-cyan-400/15 rounded-2xl border border-cyan-400/30 shadow-[0_0_20px_rgba(34,211,238,0.2)]">
            ...
            <p className="text-[13px] text-white/60 font-medium leading-relaxed mb-6 max-w-sm mx-auto relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center relative z-10">
              <a
                href="https://nancey-pandemoniacal-candra.ngrok-free.dev/classivo.apk"
                download="classivo.apk"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl font-black text-[13px] uppercase tracking-widest btn-aurora active:scale-[0.98] shadow-lg"
              >
              ...
              <button
                onClick={() => router.push("/login")}
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl font-black text-[13px] uppercase tracking-widest btn-ghost border border-white/10 active:scale-[0.98]"
              >
                Use on Browser
                <ArrowRight size={14} />
              </button>
      ...
      {/* Footer */}
      <footer className="py-8 px-6 text-center border-t border-white/10 max-w-4xl mx-auto w-full">
        <div className="flex items-center justify-center gap-2 mb-3">
          ...
          <span className="text-sm font-black text-white/70 lowercase">classivo</span>
        </div>
        ...
        <div className="flex items-center justify-center gap-4 mt-3">
          <a href="/developers" className="text-[9px] font-bold uppercase tracking-widest text-white/40 hover:text-cyan-300 transition-colors">developers</a>
          <span className="text-white/20 text-[9px]">•</span>
          <a href="/privacy" className="text-[9px] font-bold uppercase tracking-widest text-white/40 hover:text-cyan-300 transition-colors">privacy</a>
          <span className="text-white/20 text-[9px]">•</span>
          <a href="/terms" className="text-[9px] font-bold uppercase tracking-widest text-white/40 hover:text-cyan-300 transition-colors">terms</a>
        </div>
        <p className="text-[9px] text-white/20 mt-1">*server latency refers to client-side processing only</p>
      </footer>
    </div>
  );
}
